...
const REGEX_DOCS_URL = 'https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp'
    ...
    <Dialog maxWidth='md' fullWidth
      ...
      <DialogContent>
        ...
        <DialogText>
          ...
          I often use <a href={PAL_URL}>RegexPal</a> to help build complicated expressions.
        </DialogText>
        ...
        <DialogText>
          <ul>
            ...
            <li>
              You can leave comments or issues on <a href={ISSUES_URL}>GitHub</a>
            </li>
          </ul>
        </DialogText>
      </DialogContent>
